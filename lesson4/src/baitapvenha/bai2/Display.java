...
import baitapvenha.bai1.Student;
...
public class Display {
        ...
        do{
            ...
            switch(chon){
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    list.sort((s1, s2) -> Integer.compare(s1.tuoi(), s2.tuoi()));
                    inTieuDe();
                    xuatMang(list);
                    break;
                case 4 :
                    list.sort((s1, s2) -> Double.compare(s1.diemGPA(), s2.diemGPA()));
                    inTieuDe();
                    xuatMang(list);
                    break;
                case 5 :
    ...
    public static void inTieuDe(){
        System.out.printf("%-15s %-15s %-15s %-15s %-15s %-15s %-15s %-15s %n", "Ten", "Tuoi", "Dia Chi", "Diem TX1", "Diem TX2", "Diem KTHP", "Diem GPA", "So Tiet Nghi");
